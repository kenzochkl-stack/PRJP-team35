...
export default function StudentSelection() {
      ...
      try {
        ...
        if (url) {
          ...
          let dataToSet =
            step === "YEAR"
              ? json.years
              : json.specialties || json.speciality || json.data;
    ...
    if (step === "YEAR") {
      ...
      setTimeout(() => {
        if (value === "2CS") {
          ...
          router.push({
            pathname: "/(auth)/studentFlow/student-image" as any,
            params: { year: value },
          });
        }
      }, 100);
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        onPress={() =>
          step === "SPECIALITY" ? setStep("YEAR") : router.back()
        }
